...
class Problem(object):
    ...
    def actions(self, vars):
            ...
            if mrv != '':
                for num in range(0, len(vars[mrv].domain)):
                    var = mrv
    ...
    while frontier:
        ...
        for child in node.expand(problem):
            ...
            if problem.goal_test(child.state.variables):
                ...
                print("\033[91mTime running DFS: " + str(round(timeRunning,2)) + 's \033[0m')
                print("\033[91mTime running AC3 + DFS: " + str(round(timeRunning + problem.ac3Time,2)) + 's \033[0m')
